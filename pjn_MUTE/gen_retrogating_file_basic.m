function gen_retrogating_file_basic(fid,Method_Params,num)
...
% This variable contains locations of k0 points at inspiration
    ...
    answer = questdlg('Is this Retrospective Gating okay?','Gating Confirmation','Yes','No','No Gating','Yes');       
    if strcmp(answer,'No') 
    ...
    elseif strcmp(answer,'Yes')
        ...
        happy_gate = 1;
        SelectVectorExp = ones(size(k0));
        SelectVectorInsp = NaN;
    end
...
%save(['RetroGating.mat'],'Insp_indx','Exp_indx')
save(['RetroGating' num2str(num) '.mat'],'Insp_indx','Exp_indx')
